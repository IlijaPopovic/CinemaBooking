...
<body>
        ...
        <div class="main">
            ...
            <div class="input">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" name="number_seat" id="number_seat" placeholder="Number of seats">
                    ...
                    <input type="text" name="screen_size" id="screen_size" placeholder="Screen size">
                ...
                <button class="insert">Change hall</button>
            </div>
        </div>
    </div>
    ...
    <script src="scripts/change_hall.js"></script>
</body>
