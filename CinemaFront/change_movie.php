...
<body>
        ...
        <div class="main">
            ...
            <div class="input">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" name="lenght" id="lenght" placeholder="Movie lenght">
                    <input type="text" name="beginning" id="beginning" placeholder="Start date of movie ( dd.mm.yy Example: 28.7.2022 )">
                    ...
                    <textarea cols="30" rows="10" type="text" name="description" id="description" placeholder="description moviea"></textarea>
                    <textarea cols="30" rows="5" type="text" name="trailer_youtube" id="trailer_youtube" placeholder="YouTube embed code"></textarea>
                </form>
                <button class="insert">Change movie</button>
            </div>
        </div>
    </div>
    ...
    <script src="scripts/change_movie.js"></script>
</body>
