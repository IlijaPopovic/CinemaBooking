...
$(document).ready(function(){
    ...
    $.ajax({
        type: "GET",
        url: 'http://localhost/cinema/user/get_all_cinemas_and_technologies.php',
        data: {},
        dataType: 'json',
...
$('.insert').on('click',function()
    {
        if(is_all_inserted())
        {
            ...
            $.ajax({
                url:'http://localhost/cinema/user/insert_hall.php',
                type:'post',
                data:post_data,
                dataType: "json",
                contentType: false,
...
{
    if(!$('#name').val() || !$('#hall_picture').val() || $('#cinema_id').val() == 'choose' || $('#cinema_id').val() == '' || $('#technology_id').val() == 'choose' || $('#technology_id').val() == '' || isNaN($('#number_seat').val()) || isNaN($('#number_rows').val()) || isNaN($('#number_vip_rows').val()))
    {
        return false;
    }
    else
