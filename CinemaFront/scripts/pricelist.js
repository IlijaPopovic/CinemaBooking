$(document).ready(function () {
  $.ajax({
    type: "POST",
    url: "http://localhost/CinemaBooking/cinema/user/get_prices.php",
    data: {},
    dataType: "json",
      ...
      $.each(data, function (key, value) {
        if (id_admin != "no_logged_admin") {
          var delete_tehnology =
            '<td><button class="delete_tehnology" data-value="' +
            value.id +
            '">delete</button></td>';
        } else {
          var delete_tehnology = "";
    ...
    success: function (data) {
      ...
      if (id_admin != "no_logged_admin") {
        var pricelist_text_change =
          '<p><button class="pricelist_text_change">change</button></p>';
      } else {
        var pricelist_text_change = "";
      }
  ...
  $(document).on("click", ".delete_tehnology", function () {
    ...
    $.ajax({
      type: "GET",
      url: "http://localhost/CinemaBooking/cinema/user/delete_technology.php",
