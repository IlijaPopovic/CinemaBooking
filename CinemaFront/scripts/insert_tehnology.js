$(document).ready(function(){
    ...
    $('.insert').on('click',function()
    {
        if(is_all_inserted())
        {
            $.ajax({
                type: "GET",
                url: 'http://localhost/cinema/user/insert_technology.php',
                data: 
                {
    ...
    {
        if(!$('#technology_name').val() || !$('#technology_price').val() || !$('#technology_discount').val() || isNaN($('#technology_price').val()) || isNaN($('#technology_discount').val()))
        {
            return false;
        }
        else
