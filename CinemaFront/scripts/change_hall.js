...
$(document).ready(function(){
    ...
    $.ajax({
        type: "GET",
        url: 'http://localhost/cinema/user/get_hall.php',
        data: {'id': id_hall},
        dataType: 'json',
        success: function(data) 
        {
    ...
    $('.insert').on('click',function()
        {
            ...
            if(is_all_inserted())
            {
                ...
                $.ajax({
                    url:'http://localhost/cinema/user/change_hall.php',
                    type:'post',
                    data:post_data,
                    dataType: "json",
                    contentType: false,
    ...
    {
        if(!$('#name').val() || $('#cinema_id').val() == 'choose' || $('#technology_id').val() == 'choose' || isNaN($('#number_seat').val()) || isNaN($('#number_rows').val()) || isNaN($('#number_vip_rows').val()))
        {
            return false;
        }
        else
